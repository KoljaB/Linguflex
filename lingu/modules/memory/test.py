...
class MemoryTest(Test):
    ...
    def test_memory_extraction(self):
        ...
        self.request("Hi, my name is Alice Johnson.")
        self.validate("alice", "Name should be stored")
        self.validate("johnson", "Surname should be stored")
    ...
    def execute(self):
        log.inf("Starting Memory Test Suite...")
        self.test_memory_extraction()
        ...
        log.inf(f"All Memories:")
        for memory in logic.memory.get_all():
            log.inf(memory["text"])
