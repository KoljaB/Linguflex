...
class MailFetcher:
    ...
    def parse_email(email_message):
        ...
        # if subject is None:
        #     decoded_subject = ''  # or some default value
        # else:
        #     subject_header = decode_header(subject)[0]
        #     if subject_header[1]:
        #         # If charset is not None, decode it using the provided charset
        #         decoded_subject = subject_header[0].decode(subject_header[1])
        #     else:
        #         # If charset is None, we check if it's a byte string and
        #         # decode it as 'utf-8' or return it as is
        #         decoded_subject = (
        #             subject_header[0].decode('utf-8')
    ...
    def extract_text_preserve_links(html_content):
        """
        Extracts text from HTML content and preserves hyperlinks using Beautiful Soup.
        ...
        for element in soup.recursiveChildGenerator():
            ...
            elif element.name is None:  # if it's a navigable string and not a tag
    ...
    def extract_content(message_part):
        ...
        try:
            ...
            try:
                # Attempt decoding with a different charset if the first attempt fails
        ...
        # print (f"XXX content type: {content_type}")
        # print (f"XXX content text: {content_text}")
        ...
        # content_html = message_part.get_payload(decode=True)
        # if charset:
        #     content_html = content_html.decode(charset)
        # content_text = content_html
        # if content_type == 'text/html':
        #     # content_text = MailFetcher.extract_text_preserve_links(
        #     #     content_html)
        #     content_text = MailFetcher.get_text_from_html(
        #         content_html)
        # return content_text, content_html
